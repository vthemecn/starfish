...
if (!class_exists('StarFish')) {
    class StarFish {
                                ...
                                <div class="starfish-group-content">
                                    ...
                                    <?php foreach ($fields as $sub_field): ?>
                                        ...
                                        switch ($sub_field['type']) {
                                            ...
                                            case 'group':
                                                // 嵌套 Group 字段（仅支持一层嵌套）
                                                $this->render_nested_group_field($sub_field, $sub_field_name, $sub_field_id, $sub_value, $page_id);
                                                break;
                                            default:
                                                ?>
                                                <div class="starfish-sub-field">
        ...
        /**
         * 渲染嵌套 Group 字段（支持一层嵌套）
         */
        private function render_nested_group_field($field, $name, $id, $value, $page_id) {
                        ...
                        <div class="starfish-group-content">
                            <?php foreach ($nested_fields as $sub_field): ?>
                                ...
                                switch ($sub_field['type']) {
                                    ...
                                    case 'group':
                                        // 嵌套 Group 模板（仅支持一层嵌套）
                                        $this->render_nested_group_template($sub_field, $sub_field_name, $sub_field_id, $page_id);
                                        break;
                                    default:
                                        ?>
                                        <div class="starfish-sub-field">
        ...
        /**
         * 渲染嵌套 Group 模板（用于外层 Group 的模板中）
         */
        private function render_nested_group_template($field, $name, $id, $page_id) {
            $nested_fields = isset($field['fields']) ? $field['fields'] : array();
            $button_title = isset($field['button_title']) ? $field['button_title'] : __('Add New Item', 'starfish');
            $attributes = $this->get_field_attributes($field);
            ?>
                                ...
                                switch ($sub_field['type']) {
                                    ...
                                    case 'upload':
                                        ...
                                        <div class="starfish-image-wrapper starfish-sub-field">
                                            ...
                                            <div style="display: inline-block;">
                                                <?php if ($sub_show_preview): ?>
                                                    <div class="starfish-image-preview"></div>
                                                <?php endif; ?>
                                                <div class="starfish-image-action">
                                                    <input type="text" 
                                                        name="<?php echo esc_attr($sub_field_name); ?>" 
